...
namespace PolymindGames.OdinSerializer
{
    ...
    /// </summary>
    public sealed class GlobalSerializationConfig
    {
        private static readonly GlobalSerializationConfig s_Instance = new();

        /// <summary>
        /// Gets the global configuration instance.
        /// </summary>
        public static GlobalSerializationConfig Instance => s_Instance;
