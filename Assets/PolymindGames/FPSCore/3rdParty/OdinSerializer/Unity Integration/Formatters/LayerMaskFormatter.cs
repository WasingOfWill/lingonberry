...
namespace PolymindGames.OdinSerializer
{
    ...
    public sealed class LayerMaskFormatter : MinimalBaseFormatter<LayerMask>
    {
        ...
        {
            value.value = s_IntSerializer.ReadValue(reader);
        }
        ...
        {
            s_IntSerializer.WriteValue(value.value, writer);
        }
    }
}