...
namespace PolymindGames.OdinSerializer
{
    ...
    public sealed class GradientColorKeyFormatter : MinimalBaseFormatter<GradientColorKey>
    {
        ...
        {
            value.color = s_ColorSerializer.ReadValue(reader);
        ...
        {
            s_ColorSerializer.WriteValue(value.color, writer);
