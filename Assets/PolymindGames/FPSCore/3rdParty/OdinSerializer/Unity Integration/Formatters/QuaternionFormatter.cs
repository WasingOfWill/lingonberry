...
namespace PolymindGames.OdinSerializer
{
    ...
    public sealed class QuaternionFormatter : MinimalBaseFormatter<Quaternion>
    {
        ...
        protected override void Read(ref Quaternion value, IDataReader reader)
        {
            ...
            value.z = s_FloatSerializer.ReadValue(reader);
            value.w = s_FloatSerializer.ReadValue(reader);
        }
        ...
        protected override void Write(ref Quaternion value, IDataWriter writer)
        {
            ...
            s_FloatSerializer.WriteValue(value.z, writer);
            s_FloatSerializer.WriteValue(value.w, writer);
        }
    }
}