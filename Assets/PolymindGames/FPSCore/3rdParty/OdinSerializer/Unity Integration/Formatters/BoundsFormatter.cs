...
namespace PolymindGames.OdinSerializer
{
    ...
    public sealed class BoundsFormatter : MinimalBaseFormatter<Bounds>
    {
        private static readonly Serializer<Vector3> s_Vector3Serializer = Serializer.Get<Vector3>();
        ...
        {
            value.center = s_Vector3Serializer.ReadValue(reader);
            value.size = s_Vector3Serializer.ReadValue(reader);
        }
        ...
        {
            s_Vector3Serializer.WriteValue(value.center, writer);
            s_Vector3Serializer.WriteValue(value.size, writer);
        }
    }
}