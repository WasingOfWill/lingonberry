...
namespace PolymindGames.OdinSerializer
{
    ...
    public sealed class GradientAlphaKeyFormatter : MinimalBaseFormatter<GradientAlphaKey>
    {
        ...
        {
            value.alpha = s_FloatSerializer.ReadValue(reader);
        ...
        {
            s_FloatSerializer.WriteValue(value.alpha, writer);
