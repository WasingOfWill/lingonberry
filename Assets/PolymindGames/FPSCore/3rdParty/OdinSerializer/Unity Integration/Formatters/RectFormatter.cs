...
namespace PolymindGames.OdinSerializer
{
    ...
    public sealed class RectFormatter : MinimalBaseFormatter<Rect>
    {
        ...
        {
            value.x = s_FloatSerializer.ReadValue(reader);
            value.y = s_FloatSerializer.ReadValue(reader);
            value.width = s_FloatSerializer.ReadValue(reader);
            value.height = s_FloatSerializer.ReadValue(reader);
        }
        ...
        {
            s_FloatSerializer.WriteValue(value.x, writer);
            s_FloatSerializer.WriteValue(value.y, writer);
            s_FloatSerializer.WriteValue(value.width, writer);
            s_FloatSerializer.WriteValue(value.height, writer);
        }
    }
}