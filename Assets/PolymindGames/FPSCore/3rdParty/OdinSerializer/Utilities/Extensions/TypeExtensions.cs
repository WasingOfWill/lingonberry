...
namespace PolymindGames.OdinSerializer.Utilities
{
    ...
    public static class TypeExtensions
    {
        ...
        private static readonly DoubleLookupDictionary<Type, Type, Func<object, object>> WeaklyTypedTypeCastDelegates = new();
        ...
        private static HashSet<string> ReservedCSharpKeywords = new()
        {
            "abstract",
            "as",
            "base",
        ...
        private static string TypeNameGauntlet(this Type type)
        {
            ...
            if (TypeNameAlternatives.TryGetValue(typeName, out string altTypeName))
            ...
            if (constraints.Length > 0)
            {
                for (int j = 0; j < constraints.Length; j++)
                {
                    ...
                    else
                    {
                        ...
                        sb.Append(useFullTypeNames ? constraint.GetNiceFullName() : constraint.GetNiceName());
