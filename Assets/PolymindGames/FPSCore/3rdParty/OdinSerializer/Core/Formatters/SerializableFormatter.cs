...
namespace PolymindGames.OdinSerializer
{
    ...
    {
        private static readonly Func<SerializationInfo, StreamingContext, T> s_SerializableConstructor;
        private static readonly ReflectionFormatter<T> s_ReflectionFormatter;
        ...
        static SerializableFormatter()
        {
            ...
            if (constructor != null)
            {
                ...
                s_SerializableConstructor = (info, context) =>
                {
            ...
            else
            {
                ...
                s_ReflectionFormatter = new ReflectionFormatter<T>();
            }
        }
        ...
        {
            if (s_SerializableConstructor != null)
            {
                ...
                if (info != null)
                {
                    try
                    {
                        value = s_SerializableConstructor(info, reader.Context.StreamingContext);
            ...
            {
                value = s_ReflectionFormatter.Deserialize(reader);
        ...
        protected override void SerializeImplementation(ref T value, IDataWriter writer)
        {
            ...
            {
                s_ReflectionFormatter.Serialize(value, writer);
            }
        }
        ...
        {
            EntryType entry = reader.PeekEntry(out string name);
            ...
            if (entry == EntryType.StartOfArray)
            {
                try
                {
                    ...
                    for (int i = 0; i < length; i++)
                    {
                        ...
                        {
                            reader.ReadString(out string typeName);
