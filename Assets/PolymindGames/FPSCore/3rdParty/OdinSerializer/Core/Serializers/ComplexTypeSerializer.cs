...
namespace PolymindGames.OdinSerializer
{
    ...
    public sealed class ComplexTypeSerializer<T> : Serializer<T>
    {
        ...
        private static readonly Dictionary<ISerializationPolicy, IFormatter<T>> FormattersByPolicy = new(ReferenceEqualityComparer<ISerializationPolicy>.Default);
            ...
            else
            {
                switch (entry)
                {
                    ...
                    case EntryType.ExternalReferenceByString:
                        {
                            reader.ReadExternalReference(out string id);
                    ...
                    case EntryType.Boolean:
                        {
                            ...
                            reader.ReadBoolean(out bool value);
                    ...
                    case EntryType.FloatingPoint:
                        {
                            ...
                            reader.ReadDouble(out double value);
                            return (T)(object)value;
                        }
                    ...
                    case EntryType.Integer:
                        {
                            ...
                            reader.ReadInt64(out long value);
                            return (T)(object)value;
                        }
                    ...
                    case EntryType.String:
                        {
                            ...
                            reader.ReadString(out string value);
                            return (T)(object)value;
                        }
        ...
        public override void WriteValue(string name, T value, IDataWriter writer)
        {
            ...
            else
            {
                ...
                else if (context.TryRegisterExternalReference(value, out int index))
                {
                    writer.WriteExternalReference(name, index);
                }
                else if (context.TryRegisterExternalReference(value, out Guid guid))
                {
                    writer.WriteExternalReference(name, guid);
                }
                else if (context.TryRegisterExternalReference(value, out string strId))
                {
                    writer.WriteExternalReference(name, strId);
                }
                else if (context.TryRegisterInternalReference(value, out int id))
                {
