...
namespace PolymindGames.OdinSerializer
{
    ...
    public abstract class Serializer
    {
        ...
        private static readonly Dictionary<Type, Serializer> ReaderWriterCache = new(FastTypeComparer.Instance);
        ...
        {
            return Get(ReferenceEquals(value, null) ? typeof(object) : value.GetType());
        }
