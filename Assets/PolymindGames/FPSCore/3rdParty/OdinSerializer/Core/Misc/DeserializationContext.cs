...
namespace PolymindGames.OdinSerializer
{
    ...
    {
        private SerializationConfig m_Config;
        private readonly Dictionary<int, object> m_InternalIdReferenceMap = new(128);
        private readonly StreamingContext m_StreamingContext;
        private readonly IFormatterConverter m_FormatterConverter;
        private TwoWaySerializationBinder m_Binder;
        ...
        public DeserializationContext(StreamingContext context, FormatterConverter formatterConverter)
        {
            ...
            m_StreamingContext = context;
            m_FormatterConverter = formatterConverter ?? throw new ArgumentNullException(nameof(formatterConverter));
        ...
        public TwoWaySerializationBinder Binder
        {
            get
            {
                if (m_Binder == null)
                {
                    m_Binder = TwoWaySerializationBinder.Default;
                }
        ...
        /// </value>
        public IFormatterConverter FormatterConverter => m_FormatterConverter;
        ...
        public SerializationConfig Config
        {
            get
            {
                if (m_Config == null)
                {
                    m_Config = new SerializationConfig();
                }
        ...
        {
            m_InternalIdReferenceMap[id] = reference;
        }
        ...
        {
            m_InternalIdReferenceMap.TryGetValue(id, out object result);
            return result;
        }
        ...
        public object GetExternalObject(int index)
        {
            ...
            if (IndexReferenceResolver.TryResolveReference(index, out object result))
            {
                return result;
            }
        ...
        public object GetExternalObject(Guid guid)
        {
            ...
            while (resolver != null)
            {
                if (resolver.TryResolveReference(guid, out object result))
                {
                    return result;
                }
        ...
        public object GetExternalObject(string id)
        {
            ...
            while (resolver != null)
            {
                if (resolver.TryResolveReference(id, out object result))
                {
                    return result;
                }
        ...
        public void Reset()
        {
            ...
            m_InternalIdReferenceMap.Clear();
