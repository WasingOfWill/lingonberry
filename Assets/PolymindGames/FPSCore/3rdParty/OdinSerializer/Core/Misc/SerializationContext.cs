...
namespace PolymindGames.OdinSerializer
{
    ...
    public sealed class SerializationContext : ICacheNotificationReceiver
    {
        ...
        private readonly Dictionary<object, int> m_InternalReferenceIdMap = new(128, ReferenceEqualityComparer<object>.Default);
        ...
        {
            return m_InternalReferenceIdMap.TryGetValue(reference, out id);
        }
        ...
        {
            if (m_InternalReferenceIdMap.TryGetValue(reference, out id) == false)
            {
                id = m_InternalReferenceIdMap.Count;
                m_InternalReferenceIdMap.Add(reference, id);
                return true;
            }
        ...
        {
            m_InternalReferenceIdMap.Clear();
        }
